...
public enum SolverReturnStatus {
      ...
      * After optimisation, each instance of a DEAProblem class MUST have another status
      * corresponding to the optimisation results.        
      * This is important as the getWhateverPartOfTheSolution 
      * methods will in future test whether a the problem has been solved prior to     
